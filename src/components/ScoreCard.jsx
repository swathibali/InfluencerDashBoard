    ...
    return (
        <>
            <div className="scorecard__logo">
                ...
                <SmsFailedOutlinedIcon style={{fontSize: '15px',color:'rgb(156, 37, 33)'}}/>
            ...
            <div className="scorecard__description">
                <div className="scorecard__description__title">Total Engagement Score</div>
                <div className="scorecard__description__score">{totalEngagementScore}</div>
